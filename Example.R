...
#Var: names of the variable to be included in the flexible AFT model
...
#fit: object after fitting the flexible AFT model using the "FlexAFT" function
...
###for example, setting Q.high=0.9 and Q.low=0.1 for age, as using substantive knowledge, age at 90th quantile has higher risk of mortablity than age at 10th quantile
...
#fit: object after fitting the flexible AFT model using the "FlexAFT" function
#Data: Dataset that was used to fit the flexible AFT model
#time: a vector of time values which the TD time ratio computation is based on
#cov0: reference covariate pattern for the time ratio comparison
#cov1: index covariate pattern for the time ratio comparison
#pct: a vector of quantiles of time (0<pcttime<1) at which the TD time ratio is estimated
